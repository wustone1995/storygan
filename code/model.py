...
class StoryGAN(nn.Module):
    ...
    def define_module(self):
        ...
        self.fc = nn.Sequential(
            nn.Linear(ninput, ngf * 4 * 2, bias=False), #  ngf * 4 * 4 / 2 -> ngf * 4 * 2 - Deng
    ...
    def sample_videos(self, motion_input, content_input):  
        ...
        content_input = content_input.view((content_input.shape[0]*self.video_len, 
            int(content_input.shape[1]/self.video_len))) # -Deng
        ...
        zmc_code = zmc_code.view(-1, self.gf_dim//2, 4, 4) #-Deng
        # two
