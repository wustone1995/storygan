...
def _merge_a_into_b(a, b):
    ...
    for k, v in a.items(): #a.iteritems() - Deng
        # a must specify keys that are in b
        if not k in b: # if not b.has_key(k): -Deng
...
def cfg_from_file(filename):
    ...
    with open(filename, 'r') as f:
        yaml_cfg = edict(yaml.load(f, Loader=yaml.FullLoader)) # added Loader=yaml.FullLoader - Deng
